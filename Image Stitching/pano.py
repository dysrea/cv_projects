...
# Create a translation matrix to move stitched image into visible area
translation_dist = [-x_min, -y_min]
matrix_translation = np.array([[1, 0, translation_dist[0]], [0, 1, translation_dist[1]], [0, 0, 1]])

# Warp right image on canvas that is correct final size
